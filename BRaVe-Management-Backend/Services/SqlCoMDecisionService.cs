...
{
    public class SqlCoMDecisionService : ICoMDecisionService
    {
        private string connectionString { get; set; }
        public SqlCoMDecisionService(ISecretProvider secretProvider)
        {
        ...
        public async Task SaveDecision(DecisionDto data, int TenantId, string UserId)
        {
            ...
            cmd.CommandText = @"sp_SaveCoMDecision @AssessmentId,@AssessmentStatus,@Note,@IsSubmitted,@DecisionStatus,@TenantId,@UserId";
